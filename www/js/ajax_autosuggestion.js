 ...
 */
var xmlHttp;
var numTitles = 0;  //total number of suggested book titles
var activeTitle = -1;  //book title currently being selected
...
function suggest(query) {
    ...
    xmlHttp.open("GET", base_url + "/Catalog/suggest/" + query, true);
